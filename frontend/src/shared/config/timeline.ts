...
export const PERIODS = [
  { label: "Рубеж веков",         start: 1900, end: 1913, h: 45,
    description: "Индустриализация, рост городов и культурный расцвет накануне мировой катастрофы." },
  { label: "Первая мировая",      start: 1914, end: 1918, h: 15,
    description: "Россия в годы Великой войны: фронт, революционные потрясения и распад империи." },
  { label: "Межвоенный период",   start: 1919, end: 1938, h: 160,
    description: "НЭП, коллективизация, индустриализация и сталинские репрессии." },
  { label: "Вторая мировая",      start: 1939, end: 1945, h: 0,
    description: "Великая Отечественная война: от пакта Молотова–Риббентропа до Победы." },
  { label: "Холодная война",      start: 1946, end: 1991, h: 220,
    description: "СССР на мировой арене: гонка вооружений, космос, оттепель и застой." },
  { label: "Постсоветская эпоха", start: 1992, end: 2000, h: 280,
    description: "Распад СССР, экономические реформы и становление новой России." },
];
